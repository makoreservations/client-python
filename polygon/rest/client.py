...
class RESTClient:
    ...
    def reference_stock_financials_beta(self, **query_params) -> models.ReferenceStockFinancialsBetaApiResponse:
        endpoint = f"{self.url}/vX/reference/financials"
        return self._handle_response("ReferenceStockFinancialsBetaApiResponse", endpoint, query_params)
